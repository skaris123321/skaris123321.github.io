    ...
    return {
      ...
      getCommutationDescription() {
        if (this.commutationType === 'control_cabinet') {
          ...
          // Для ящиков управления электродвигателями
          const isAuto = this.feederType === 'double_with_auto';
          
          return {
            purpose: `Ящики управления типа Я5000 предназначены для местного, дистанционного и автоматического управления асинхронными электродвигателями с короткозамкнутым ротором мощностью до 75 кВт, работающими в продолжительном, кратковременном и повторно-кратковременном режимах. Обеспечивает:`,
            purposeList: [
              'надёжный пуск и остановку электродвигателя;',
              'защиту от перегрузок, коротких замыканий и обрыва фаз;',
              'местное и дистанционное управление;',
              isAuto ? 'автоматическое переключение между фидерами при аварии;' : 'ручное переключение между фидерами;',
              'визуальный контроль состояния работы.'
            ],
            workflow: [
              {
                title: 'Конструкция',
                text: 'Ящики управления типа Я5000 изготавливаются со степенью защиты IP31. Ящики управления монтируются в металлических шкафах с монтажной панелью. Ящики комплектуются в зависимости от обозначения и типового индекса: автоматическими выключателями, контакторами, тепловыми реле, светосигнальной арматурой и аппаратурой управления (кнопки, переключатели).'
              },
              {
                title: 'Параметры питания',
                text: 'Номинальное напряжение главной цепи – 400 В. Номинальное напряжение цепи управления – 230 В.'
              },
              {
                title: 'Режимы работы',
                text: isAuto 
                  ? 'Местное управление (с панели ящика); дистанционное управление (по внешним сигналам); автоматический режим (автоматическое переключение между фидерами при аварии на основном).'
                  : 'Местное управление (с панели ящика); дистанционное управление (по внешним сигналам); ручное переключение между фидерами.'
              },
              {
                title: 'Защитные функции',
                text: 'От короткого замыкания (автоматический выключатель); от перегрузки по току (тепловое реле); от обрыва фазы; от пониженного напряжения; световая сигнализация аварийных состояний.'
              }
            ],
            features: [
              {
                name: 'Высокий уровень надёжности',
                desc: '— Высокий уровень надёжности и безопасности в эксплуатации групп асинхронных двигателей'
              },
              {
                name: 'Широкий выбор модификаций',
                desc: '— Широкий выбор модификаций'
              },
              {
                name: 'Высокая технологичность',
                desc: '— Высокая технологичность и простота сборки'
              },
              {
                name: 'Электробезопасность',
                desc: '— Высокий уровень электробезопасности'
              },
              {
              ...
              {
                name: 'Сертифицированные сборщики',
                desc: '— Наличие сертифицированных сборщиков в крупнейших регионах РФ'
              },
              {
                name: 'Короткие сроки поставки',
                desc: '— Короткие сроки поставки компонентов решения обеспечиваются наличием широкой складской и партнерской сети'
              }
            ].concat(isAuto ? [{
              name: 'Автоматический режим',
              desc: '— Автоматический режим работы обеспечивает бесперебойное электроснабжение при переключении между фидерами'
            }] : [])
          };
        }
      },
